...
export function HeroSection() {
  return (
    <section className="relative h-screen flex flex-col justify-between overflow-hidden pt-20 pb-8">      
      ...
      {/* Content */}
      <div className="relative z-10 flex-1 flex items-end w-full pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          {/* Text Content */}
          <div className="text-left pb-8 -ml-8 lg:-ml-16 max-w-5xl lg:max-w-6xl">
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            성과를 만드는 광고, 수익을 만드는 플랫폼,<br />
            ...
            <div className="flex gap-4">
              <Button
                size="lg"
                className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white border-0 px-12 py-7 text-lg font-semibold shadow-2xl shadow-indigo-500/30 transition-all duration-300 hover:scale-105"
              >
                프로젝트 문의하기
      ...
      <div className="relative z-10 flex items-center justify-center gap-2 text-gray-400 text-sm pb-4">
